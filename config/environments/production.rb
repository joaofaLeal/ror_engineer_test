Rails.application.configure do
  ...
  # config.x.contract.size            = 10
  # config.x.contract.maxlength       = 10
  # config.x.contract.placeholder     = '012345789'
  ...
  # config.active_job.queue_name_prefix = "test-data-mgmt_#{Rails.env}"
